        ...
        class Dashboard {
            ...
            toggleSubmenu(toggle) {
                ...
                document.addEventListener('DOMContentLoaded', function () {
                    // Ensure server-rendered .active parents have their submenu visible
                    document.querySelectorAll('.sidebar nav ul li.active .submenu').forEach(function (el) {
                        el.style.display = 'block';
                    });
                
                    // Toggle behavior when user clicks menu-toggle
