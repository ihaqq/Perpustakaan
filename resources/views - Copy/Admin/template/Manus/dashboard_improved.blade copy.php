...
<head>
    ...
    @vite('resources/css/manus/dashboard_improved.css')
            ...
            <nav>
                <ul>
                    ...
                    <li>
                        ...
                        <ul class="submenu">
                            <li><a href="siperpus/anggota.html"><i class="fas fa-list"></i>Daftar Anggota</a></li>
    ...
    <script>
        ...
        class Dashboard {
            ...
            populateData() {
                ...
                const members = [
                    { nama: 'Dinda Permata Sari', kelas: 'XII IPA 1', tanggal: '2024-05-01' },
                    { nama: 'Budi Santoso', kelas: 'XI IPS 2', tanggal: '2024-04-28' },
                    { nama: 'Siti Rahayu', kelas: 'X MIPA 3', tanggal: '2024-04-25' },
                    { nama: 'Ahmad Fauzi', kelas: 'XII IPS 1', tanggal: '2024-04-22' },
                    { nama: 'Maya Sari', kelas: 'XI IPA 2', tanggal: '2024-04-20' }
                ];
                ...
                const books = [
                    ...
                    { judul: 'Sapiens', pengarang: 'Yuval Noah Harari', stok: 8 },
                    { judul: 'The Psychology of Money', pengarang: 'Morgan Housel', stok: 12 }
                ];

                this.populateTable('memberTableBody', members, ['nama', 'kelas', 'tanggal']);
